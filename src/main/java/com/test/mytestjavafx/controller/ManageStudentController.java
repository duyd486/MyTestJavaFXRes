...
public class ManageStudentController extends HelloApplication implements Initializable {
    ...
    private void onAddStudentClick(){
        ...
        try {
            FXMLLoader loader = new FXMLLoader(HelloApplication.class.getResource("view/add-student.fxml"));
